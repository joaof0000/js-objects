const album1 = {
  ...
  const labels = album5.albumDetails.labels;
  ...
  talkingHeadsAlbums[5].albumDetails.released = new Date('October 7, 1986');
  talkingHeadsAlbums[6].albumDetails.released = new Date('March 15, 1988');
